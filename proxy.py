...
def proxy_pool(amount_of_ip):
	...
	mainurl="https://gimmeproxy.com/api/getProxy?get=true&anonymityLevel=1&supportsHttps=True&maxCheckPeriod=3600"
...
"""
def get_one_from_pool(pool):
	res={}
	ipPool = pool
	res['https']=ipPool[randint(0,len(pool)-1)]
	return res
"""
